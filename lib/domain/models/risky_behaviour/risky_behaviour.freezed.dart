...
mixin _$RiskyBehaviour {
 ...
 String get behaviourId; DateTime get detectedTime; String get behaviourType; String get alertTypeName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,behaviourId,detectedTime,behaviourType,alertTypeName);

@override
String toString() {
  return 'RiskyBehaviour(behaviourId: $behaviourId, detectedTime: $detectedTime, behaviourType: $behaviourType, alertTypeName: $alertTypeName)';
}
...
@useResult
$Res call({
 String behaviourId, DateTime detectedTime, String behaviourType, String alertTypeName
});
...
/// Create a copy of RiskyBehaviour
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? behaviourId = null,Object? detectedTime = null,Object? behaviourType = null,Object? alertTypeName = null,}) {
...
class _RiskyBehaviour implements RiskyBehaviour {
   _RiskyBehaviour({required this.behaviourId, required this.detectedTime, required this.behaviourType, required this.alertTypeName});
...
/// Create a copy of RiskyBehaviour
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? behaviourId = null,Object? detectedTime = null,Object? behaviourType = null,Object? alertTypeName = null,}) {
